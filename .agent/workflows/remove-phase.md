...
## 7. Register Operation in STATE.md
...
## 8. Check ROADMAP.md for Conflicts
...
$stateContent = [regex]::Replace($stateContent, "\r?\n## Pending Operation.*?\r?\n(?=## |\Z)", "`n## Last Operation`n- **ID**: $operationId`n- **Workflow**: /remove-phase`n- **Completed**: $(Get-Date -Format "yyyy-MM-ddTHH:mm:ss")`n- **Status**: completed`n", [System.Text.RegularExpressions.RegexOptions]::Singleline)
Set-Content ".gsd/STATE.md" $stateContent -NoNewline
```
