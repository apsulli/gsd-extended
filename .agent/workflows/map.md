...
This workflow should be run BEFORE `/plan-phase` on brownfield projects to give the planner full context.
</objective>
...
/plan-phase — create execution plans with full context
...
|---------|--------------|
| `/plan-phase` | Use ARCHITECTURE.md from /map for planning context |
