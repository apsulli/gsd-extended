...
**Image AI — Generation** (Midjourney, DALL-E 3, Stable Diffusion, Nano Banana)
...
- Nano Banana: natural language prose (like DALL-E 3). No weighted tokens. Supports aspect ratios (16:9, 9:16, 1:1, etc.), resolution (1K/2K/4K), and style presets (Realistic, Anime, Fantasy, Portrait, Landscape, Cyberpunk, 3D Render). Excellent text rendering — use quotes for text. Prefers positive framing over negative prompts.
